let ballot = {
  contests: [
    ...
    },
    {
      ...
      contestCode: "",
      contestType: "Q",
      questionText: ["Do you favor a $105,000,000 bond issue to build or improve roads, bridges, railroads, airports, transit and ports and make other transportation investments, to be used to match an estimated $137,000,000 in federal and other funds?","",	  
	  "Total estimated life time cost is $133,875,000 representing $105,000,000 in principal and $28,875,000 in interest (assuming interest at 5.0% over 10 years).","",
    ...
    },
    {
      ...
      contestCode: "",
      contestType: "Q",
      questionText: ["Do you favor a $15,000,000 bond issue to invest in highspeed internet infrastructure for unserved and underserved areas, to be used to match up to $30,000,000 in federal, private, local or other funds?","",	  
	  ...
	  "A \"Yes\" vote approves the issuance of up to fifteen million dollars ($15,000,000) in general obligation bonds to finance highspeed internet infrastructure.","",	  
	  "A \"No\" vote opposes the bond issue in its entirety."],
      voteFor: 1,
      votingInstructions: "Vote Yes or No",
      candidates: [
    ...
    {
	  header: "CITY OF ANY TOWN<br>REGULAR AND SPECIAL MUNICIPAL ELECTION<br>NOVEMBER 3, 2020<br>WARD 6",
      contestName: "Mayor",
      ...
      candidates: [
        {
          candidateName: "Appleseed, Johnny",
          candidateSubtitle: "53 Pleasantdale Ave.",
          candidateCode: "",
          selected: 0
        },
        {
          candidateName: "Smith, Mary",
    ...
    },
    {
      ...
      contestCode: "",
      contestType: "Q",
      questionText: ["Shall the City of Any Town approve the Charter revision recommended by the Charter Commission?"],
      voteFor: 1,
      votingInstructions: "Vote Yes or No",
      candidates: [
        {
