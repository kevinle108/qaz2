...
function warningUncheckAnotherCandidate(ovalId, sameColSelection) {
	...
	document.getElementById("rcModalText").innerHTML = `For ${ordinal} choice, you previously selected ${otherCandidateName}. Do you want to change your ${ordinal} choice to ${selectedCandidateName}?`
